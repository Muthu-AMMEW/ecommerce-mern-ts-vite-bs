            ...
            <footer className="container-fluid bg-body-tertiary p-2 p-sm-5 pb-1 mm-navbg">
                <div className="row">
                    ...
                    <div className="col-6 col-md d-flex flex-column mb-2 justify-content-around">
                        ...
                        <img src="/images/no-play-store.png" className='install-button' onClick={handleClick} alt="Play Store App" title={titleName} width="160" height="50" />
                        <img src="/images/no-app-store.png" className='install-button' onClick={handleClick} alt="App Store App" title={titleName} width="160" height="50" />
                    </div>
